...
[the `command` package](https://pkg.go.dev/github.com/jameswoolfenden/terraform/command).
...
[`backend.Operation`](https://pkg.go.dev/github.com/jameswoolfenden/terraform/backend#Operation)
...
[`backend.Backend`](https://pkg.go.dev/github.com/jameswoolfenden/terraform/backend#Backend), using a
mapping table in
[the `backend/init` package](https://pkg.go.dev/github.com/jameswoolfenden/terraform/backend/init).

Backends that are able to execute operations additionally implement
[`backend.Enhanced`](https://pkg.go.dev/github.com/jameswoolfenden/terraform/backend#Enhanced);
...
[`local.Local`](https://pkg.go.dev/github.com/jameswoolfenden/terraform/backend/local#Local),
...
(either
[`statemgr.Filesystem`](https://pkg.go.dev/github.com/jameswoolfenden/terraform/states/statemgr#Filesystem) if the
...
[`terraform.Context`](https://pkg.go.dev/github.com/jameswoolfenden/terraform/terraform#Context),
...
[`Plan`](https://pkg.go.dev/github.com/jameswoolfenden/terraform/terraform#Context.Plan)
or
...
[package `configs`](https://pkg.go.dev/github.com/jameswoolfenden/terraform/configs).
A whole configuration (the root module plus all of its descendent modules)
is represented by
[`configs.Config`](https://pkg.go.dev/github.com/jameswoolfenden/terraform/configs#Config).
...
[`configload`](https://pkg.go.dev/github.com/jameswoolfenden/terraform/configs/configload]),
via
[`configload.Loader`](https://pkg.go.dev/github.com/jameswoolfenden/terraform/configs/configload#Loader).
...
[the `statemgr` package](https://pkg.go.dev/github.com/jameswoolfenden/terraform/states/statemgr),
with most practical managers implementing the full set of operations
described by
[`statemgr.Full`](https://pkg.go.dev/github.com/jameswoolfenden/terraform/states/statemgr#Full)
...
The implementation
[`statemgr.Filesystem`](https://pkg.go.dev/github.com/jameswoolfenden/terraform/states/statemgr#Filesystem) is used
...
[`states.State`](https://pkg.go.dev/github.com/jameswoolfenden/terraform/states#State)
...
[`GraphNodeConfigResource`](https://pkg.go.dev/github.com/jameswoolfenden/terraform/terraform#GraphNodeConfigResource)
...
[`terraform.GraphTransformer`](https://pkg.go.dev/github.com/jameswoolfenden/terraform/terraform#GraphTransformer).
...
* [`ConfigTransformer`](https://pkg.go.dev/github.com/jameswoolfenden/terraform/terraform#ConfigTransformer),
  which creates a graph vertex for each `resource` block in the configuration.

* [`StateTransformer`](https://pkg.go.dev/github.com/jameswoolfenden/terraform/terraform#StateTransformer),
  which creates a graph vertex for each resource instance currently tracked
  in the state.

* [`ReferenceTransformer`](https://pkg.go.dev/github.com/jameswoolfenden/terraform/terraform#ReferenceTransformer),
...
* [`ProviderTransformer`](https://pkg.go.dev/github.com/jameswoolfenden/terraform/terraform#ProviderTransformer),
...
[`terraform.Graph`](https://pkg.go.dev/github.com/jameswoolfenden/terraform/terraform#Graph), which
...
[the low-level `dag` package](https://pkg.go.dev/github.com/jameswoolfenden/terraform/dag#AcyclicGraph.Walk)
(where "DAG" is short for [_Directed Acyclic Graph_](https://en.wikipedia.org/wiki/Directed_acyclic_graph)), in
[`AcyclicGraph.Walk`](https://pkg.go.dev/github.com/jameswoolfenden/terraform/dag#AcyclicGraph.Walk).
However, the "interesting" Terraform walk functionality is implemented in
[`terraform.ContextGraphWalker`](https://pkg.go.dev/github.com/jameswoolfenden/terraform/terraform#ContextGraphWalker),
...
* `EnterPath` is called once for each module in the configuration, taking a
  ...
  [`terraform.EvalContext`](https://pkg.go.dev/github.com/jameswoolfenden/terraform/terraform#EvalContext)
...
[`states.SyncState`](https://pkg.go.dev/github.com/jameswoolfenden/terraform/states#SyncState)
...
[`terraform.EvalNode`](https://pkg.go.dev/github.com/jameswoolfenden/terraform/terraform#EvalNode).
...
[`terraform.BuiltinEvalContext`](https://pkg.go.dev/github.com/jameswoolfenden/terraform/terraform#BuiltinEvalContext).
...
[`terraform.GraphNodeEvalable`](https://pkg.go.dev/github.com/jameswoolfenden/terraform/terraform#GraphNodeEvalable),
which has a single method that returns an `EvalNode`. In practice, most
implementations return an instance of
[`terraform.EvalSequence`](https://pkg.go.dev/github.com/jameswoolfenden/terraform/terraform#EvalSequence),
...
* [`EvalReadState`](https://pkg.go.dev/github.com/jameswoolfenden/terraform/terraform#EvalReadState),
  which extracts the data for a particular resource instance from the state.

* [`EvalWriteState`](https://pkg.go.dev/github.com/jameswoolfenden/terraform/terraform#EvalWriteState),
...
* [`EvalInitProvider`](https://pkg.go.dev/github.com/jameswoolfenden/terraform/terraform#EvalInitProvider),
...
* [`EvalGetProvider`](https://pkg.go.dev/github.com/jameswoolfenden/terraform/terraform#EvalGetProvider),
  which retrieves an already-initialized provider that is cached in the
  `EvalContext`.

* [`EvalValidateResource`](https://pkg.go.dev/github.com/jameswoolfenden/terraform/terraform#EvalValidateResource),
...
* [`EvalApply`](https://pkg.go.dev/github.com/jameswoolfenden/terraform/terraform#EvalApply),
...
1. Analyze the configuration expressions to see which other objects they refer
  ...
  [`lang.References`](https://pkg.go.dev/github.com/jameswoolfenden/terraform/lang#References),
  or more often one of the helper wrappers around it:
  [`lang.ReferencesInBlock`](https://pkg.go.dev/github.com/jameswoolfenden/terraform/lang#ReferencesInBlock)
  or
  [`lang.ReferencesInExpr`](https://pkg.go.dev/github.com/jameswoolfenden/terraform/lang#ReferencesInExpr)
...
of the methods on [`lang.Scope`](https://pkg.go.dev/github.com/jameswoolfenden/terraform/lang#Scope);
most commonly,
[`lang.EvalBlock`](https://pkg.go.dev/github.com/jameswoolfenden/terraform/lang#Scope.EvalBlock)
or
[`lang.EvalExpr`](https://pkg.go.dev/github.com/jameswoolfenden/terraform/lang#Scope.EvalExpr).
...
[`terraform.GraphNodeDynamicExpandable`](https://pkg.go.dev/github.com/jameswoolfenden/terraform/terraform#GraphNodeDynamicExpandable).
