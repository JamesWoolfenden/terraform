...
import (
	...
	backendRemote "github.com/jameswoolfenden/terraform/backend/remote"
	backendArtifactory "github.com/jameswoolfenden/terraform/backend/remote-state/artifactory"
	backendAzure "github.com/jameswoolfenden/terraform/backend/remote-state/azure"
	backendConsul "github.com/jameswoolfenden/terraform/backend/remote-state/consul"
	backendCos "github.com/jameswoolfenden/terraform/backend/remote-state/cos"
	backendEtcdv2 "github.com/jameswoolfenden/terraform/backend/remote-state/etcdv2"
	backendEtcdv3 "github.com/jameswoolfenden/terraform/backend/remote-state/etcdv3"
	backendGCS "github.com/jameswoolfenden/terraform/backend/remote-state/gcs"
	backendHTTP "github.com/jameswoolfenden/terraform/backend/remote-state/http"
	backendInmem "github.com/jameswoolfenden/terraform/backend/remote-state/inmem"
	backendKubernetes "github.com/jameswoolfenden/terraform/backend/remote-state/kubernetes"
	backendManta "github.com/jameswoolfenden/terraform/backend/remote-state/manta"
	backendOSS "github.com/jameswoolfenden/terraform/backend/remote-state/oss"
	backendPg "github.com/jameswoolfenden/terraform/backend/remote-state/pg"
	backendS3 "github.com/jameswoolfenden/terraform/backend/remote-state/s3"
	backendSwift "github.com/jameswoolfenden/terraform/backend/remote-state/swift"
)
