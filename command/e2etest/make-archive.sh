...
go test -o "$OUTDIR/e2etest$GOEXE" -c -ldflags "-X github.com/jameswoolfenden/terraform/command/e2etest.terraformBin=./terraform$GOEXE" github.com/jameswoolfenden/terraform/command/e2etest
